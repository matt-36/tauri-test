...
var app = (function () {
    ...
    const file$4 = "src-svelte\\components\\Navbar.svelte";
    ...
    class Navbar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { pgn: 0 }, add_css$3);
    ...
    const file$3 = "src-svelte\\components\\Switch.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 57, 4, 1110);
    			attr_dev(span, "class", "slider svelte-1f2rgho");
    			add_location(span, file$3, 58, 4, 1154);
    			attr_dev(label, "class", "switch svelte-1f2rgho");
    			add_location(label, file$3, 56, 2, 1082);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Switch extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { checked: 0 }, add_css$2);
    ...
    const file$2 = "src-svelte\\pages\\Chatlist.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 13, 4, 237);
    			attr_dev(div1, "class", "btn grad");
    			add_location(div1, file$2, 14, 4, 310);
    			attr_dev(div2, "class", "btn grad");
    			add_location(div2, file$2, 16, 6, 416);
    			...
    			add_location(textarea0, file$2, 18, 8, 526);
    			attr_dev(div3, "class", "serverlink svelte-1ymzol6");
    			add_location(div3, file$2, 17, 6, 492);
    			attr_dev(div4, "class", "inlineserver svelte-1ymzol6");
    			add_location(div4, file$2, 15, 4, 382);
    			attr_dev(div5, "class", "tlgrid svelte-1ymzol6");
    			add_location(div5, file$2, 12, 2, 211);
    			attr_dev(div6, "class", "head svelte-1ymzol6");
    			add_location(div6, file$2, 28, 20, 756);
    			attr_dev(div7, "class", "logs svelte-1ymzol6");
    			add_location(div7, file$2, 28, 2, 738);
    			add_location(div8, file$2, 30, 4, 820);
    			attr_dev(div9, "class", "blgrid svelte-1ymzol6");
    			add_location(div9, file$2, 29, 2, 794);
    			attr_dev(div10, "class", "head svelte-1ymzol6");
    			add_location(div10, file$2, 33, 23, 925);
    			attr_dev(div11, "class", "chatlog svelte-1ymzol6");
    			add_location(div11, file$2, 33, 2, 904);
    			...
    			add_location(textarea1, file$2, 35, 4, 993);
    			attr_dev(div12, "class", "message svelte-1ymzol6");
    			add_location(div12, file$2, 34, 2, 966);
    			attr_dev(div13, "class", "content svelte-1ymzol6");
    			add_location(div13, file$2, 11, 0, 186);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
